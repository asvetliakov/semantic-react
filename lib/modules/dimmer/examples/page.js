...
var MyPageDimmer = function (_React$Component) {
    _inherits(MyPageDimmer, _React$Component);

    function MyPageDimmer() {
        _classCallCheck(this, MyPageDimmer);

        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(MyPageDimmer).call(this));
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    _dimmer2.default,
                    { page: true, active: this.state.dimmed, onClick: function onClick() {
                            return _this2.setState({ dimmed: false });
                        } },
...
_react2.default.createElement(MyPageDimmer, null);
